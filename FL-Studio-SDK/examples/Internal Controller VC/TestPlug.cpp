...
extern "C" __declspec(dllexport) TFruityPlug * _stdcall CreatePlugInstance(TFruityPlugHost *Host, intptr_t Tag)
{
...
TTestPlug::TTestPlug(intptr_t Tag, TFruityPlugHost *Host)
