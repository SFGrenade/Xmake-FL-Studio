...
// c++11 doesn't allow 'const char [#]' to 'char *'
static char g_octave[] = "octave";
static char g_semitone[] = "semitone";
static char g_cent[] = "cent";
static char g_Hz[] = "Hz";
...
{
    char *PitchTypeT[4];
    PitchTypeT[0] = g_octave;  // todo: fixme: HERE PUT g_ SHIT
    PitchTypeT[1] = g_semitone;  // todo: fixme: HERE PUT g_ SHIT
    PitchTypeT[2] = g_cent;  // todo: fixme: HERE PUT g_ SHIT
    PitchTypeT[3] = g_Hz;  // todo: fixme: HERE PUT g_ SHIT
